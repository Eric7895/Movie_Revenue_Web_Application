...
-   **Ordinary Least Squares (OLS)**: Baseline linear modeling for interpretability.
...
-   **Trailer Likes (log)**: Linear positive impact; increased trailer engagement reliably raises revenue.
...
#### Strengths:
Realistic time-based training/testing split simulates practical forecasting scenarios effectively.
Demonstrated strong generalization with minimal data leakage risk.
